...
// end subtitle rotation component for hero section
  // ---------------------------------------------------------
  // RETURN UI This is the section you change the body background. KEY WORK BACKGROUND HERE
  // ---------------------------------------------------------
  return (
  <main
  style={{
